...
const data = {
  ...
  infos: {
    "Nom du service": "Réparation de meubles anciens",
    "Artisan responsable": "Yasmine Roukas",
    "Spécialité de l'artisan":
      "Ébéniste spécialisée dans la restauration de meubles traditionnels",
    Description:
      "Service de réparation et de restauration de meubles anciens avec des techniques artisanales.",
    Localisation: "Béjaïa",
    "Prix estimé": "À partir de 15 000 DA (selon l'état du meuble)",
    "Durée estimée du service": "1 à 2 semaines",
    "Conditions spécifiques":
      "L'artisan nécessite une photo préalable du meuble pour évaluer les réparations. Les déplacements à domicile sont possibles avec des frais supplémentaires.",
    "Informations supplémentaires":
      "Garantie de 6 mois sur les réparations effectuées.",
  },
  files: [
    {
...
export default function DemandeDetailsPage() {
  return (
    <div className="w-[90%] flex flex-col items-center bg-white border rounded-lg shadow-md p-6 px-9 mx-4 mt-4">
      <Link className="w-full flex items-center mb-3" href="/admin/demandes">
        <svg
